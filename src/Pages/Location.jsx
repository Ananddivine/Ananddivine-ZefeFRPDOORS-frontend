...
const Location = () => {
  ...
  const shops = [
      ...
      //   id: 20,    
      //   name: 'Shop 20',
      //   lat: 12.92911911433011,
      //   lng: 77.62174057916887, 
      //   contact: '9605032855',
      //   iframe: '<iframe src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d1944.3341114878742!2d77.62082862729004!3d12.929032846949676!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMTLCsDU1JzQ0LjUiTiA3N8KwMzcnMTguMyJF!5e0!3m2!1sen!2sin!4v1724576682598!5m2!1sen!2sin"></iframe>'
      // }
    ...
    useEffect(() => {
      if (userLocation) {
        ...
        const nearby = shops.filter((shop) => {
          ...
          console.log(`Distance to ${shop.name}: ${distance} km (Radius: ${radius} km)`); // Log distance and radius
          ...
          <div className='radious-top'>
            ...
            {radius < 230 && (
              <div className='radious'>
                ...
                {radius === 100 && (
                  <button onClick={() => setRadius(150)}>Search within 150 km</button>
                )}
                {radius === 150 && (
                  <button onClick={() => setRadius(230)}>Search within 200 km</button>
                )}
              </div>
            )}
            {radius === 230 && (
            ...
            <div className="shops-container">
              {nearbyShops.map((shop) => (
                <div key={shop.id} className="shop-item">
                  ...
                  <p>Contact:  <a href={`tel:${shop.contact}`}>{shop.contact}</a></p>
